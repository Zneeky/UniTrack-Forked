    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeTeacher", x => new { x.GradesId, x.TeachersId });
                    table.ForeignKey(
                        name: "FK_GradeTeacher_Grades_GradesId",
                        column: x => x.GradesId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GradeTeacher_Teachers_TeachersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeSubjectTeachers", x => new { x.GradeId, x.TeacherId, x.SubjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeTeacher_TeachersId",
                table: "GradeTeacher",
                column: "TeachersId");
